...
module.exports.RungeKutta1Order = function( func, ops ) {
	...
	this.nextStep = function( x0, y0, h ) {
		...
		var k2 = ops.mulConst(func( ops.add(x0, hHalf), ops.add(y0, ops.mulConst(k1, 0.5)) ), h);			
		var k3 = ops.mulConst(func( ops.add(x0, hHalf), ops.add(y0, ops.mulConst(k2, 0.5)) ), h);			
		var k4 = ops.mulConst(func( ops.add(x0, h), ops.add(y0, k3) ), h);			
...
module.exports.RungeKutta2Order = function( func, ops ) {
	...
	this.nextStep = function( x0, y0, dy0, h ) {
		...
		var m2 = ops.mulConst(func( ops.add(x0, hHalf), ops.add(y0, ops.mulConst(k1, 0.5)), ops.add(dy0, ops.mulConst(m1, 0.5)) ), h);
		
		var k3 = ops.mulConst(ops.add(dy0, ops.mulConst(m2, 0.5)), h);			
		var m3 = ops.mulConst(func( ops.add(x0, hHalf), ops.add(y0, ops.mulConst(k2, 0.5)), ops.add(dy0, ops.mulConst(m2, 0.5)) ), h);

		var k4 = ops.mulConst(ops.add(dy0, m3), h);
		var m4 = ops.mulConst(func( ops.add(x0, h), ops.add(y0, k3), ops.add(dy0, m3) ), h);		
